				...
				<div class="row">
					<div class="col-xl-8">
						...
						<div class="js-slick-slider slick_slider">
								...
								<div class="slick_slider-item">
									<img class="d-block img-fluid" src="images/slide002.png" alt="Second slide"/>
								</div>
								<div class="slick_slider-item">
									<img class="d-block img-fluid" src="images/slide001.png" alt="Third slide"/>
								</div>
								<div class="slick_slider-item">
									<img class="d-block img-fluid" src="images/slide002.png" alt="Third slide"/>
								</div>
					...
					<div class="col-xl-4">
						<div class="links_bars_block row">
							<div class="col-lg-12 col-xl-12">
								<a href="#" class="links_bars_block-link d-block w-100 text-uppercase text-bold position-relative">
									<span class="links_bars_block-link-marker position-absolute"></span>
									<span class="links_bars_block-link-title d-block text-orange">Онлайн-запись</span>
									<span class="links_bars_block-link-text d-block text-dark">Запишитесь прямо сейчас</span>
								</a>
							</div>
							...
							<a href="#" class="links_bars_block-link d-block w-100 text-uppercase text-bold position-relative">
								<span class="links_bars_block-link-marker position-absolute"></span>
								<span class="links_bars_block-link-title d-block text-orange">Найти ближайший автосервис</span>
								<span class="links_bars_block-link-text d-block text-dark">Сервис на карте</span>
							</a>
							</div>
							...
							<a href="#" class="links_bars_block-link d-block w-100 text-uppercase text-bold position-relative">
								<span class="links_bars_block-link-marker position-absolute"></span>
								<span class="links_bars_block-link-title d-block text-orange">Заказать звонок</span>
								<span class="links_bars_block-link-text d-block text-dark">Наш менеджер свяжется с вами</span>
							</a>
							</div>
						</div>
					</div>
